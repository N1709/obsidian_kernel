 ...
 * dispatcher. Exceptions escalate to panic(); hardware IRQs fan out
 * to handlers registered by drivers through irq_install().
 */
...
static const char *exception_name(u32 vector) {
