...
static void idt_set_gate(int n, u64 handler) {
	idt[n].base_low  = (u16)(handler & 0xFFFF);
	idt[n].base_mid  = (u16)((handler >> 16) & 0xFFFF);
	idt[n].base_high = (u32)((handler >> 32) & 0xFFFFFFFF);
